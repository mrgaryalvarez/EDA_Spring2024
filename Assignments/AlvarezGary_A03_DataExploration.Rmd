...
```{r,  message = FALSE}
getwd() #I checked that my Working directory is set to the base folder for the Environmental Data Analytics Course repository.
...
write.csv(, file = "./Data/Processed/USGS_Site02085000_Flow_Processed.csv", row.names=FALSE)
```
