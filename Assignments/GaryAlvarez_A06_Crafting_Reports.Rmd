...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap= "Ozone Levels Distribution by Month (2018)", fig.align='left', fig.dim = c(6, 4)}

# Filtering data for year 2018
epa_data_2018 <- filter(epa_data, year(Date) == 2018)

# Creating boxplot for 2018
ggplot(epa_data_2018, aes(x = month(Date, label = TRUE), y = Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "Ozone Levels (ppm)", title = "Ozone Levels Distribution by Month (2018)") +
  theme_minimal()


```

```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap= "Ozone Levels Distribution by Month (2019)", fig.align='left', fig.dim = c(6, 4)}

# Filtering data for 2019
epa_data_2019 <- filter(epa_data, year(Date) == 2019)

# Creating boxplot for 2019
ggplot(epa_data_2019, aes(x = month(Date, label = TRUE), y = Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "Ozone Levels (ppm)", title = "Ozone Levels Distribution by Month (2019)") +
  theme_minimal()
```
...
https://github.com/mrgaryalvarez/EDA_Spring2024.git
