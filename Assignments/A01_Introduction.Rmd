...
## Directions
1.  Rename this file `<GaryAlvarez>_A01_Introduction.Rmd` (replacing `<FirstLast>` with your first and last name).
...
> Answer: The only experiences I have with data analytics are a basic Excel course I made last year and my statistics for policy makers course last year.
...
> Answer: https://github.com/mrgaryalvarez/EDA_Spring2024.git
